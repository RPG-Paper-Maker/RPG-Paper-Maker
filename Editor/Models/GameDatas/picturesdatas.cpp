...
void PicturesDatas::setDefaultObjects3D(QList<QString> &names) {
    names << "chest" << "chest-opened1" << "chest-opened2" << "cupboard" <<
        "fridge" << "table" << "bottom-chair" << "chair-back" << "big-log" <<
        "small-log" << "tiny-log" << "cobblestone-cube" << "dresser" <<
        "giant-wood-building" << "wood-deck" << "brick-building" << "bed" <<
        "dining-table" << "cabinets1" << "cabinets2" << "macrowave" <<
        "shop-stand1" << "shop-stand2" << "big-brick-building" <<
        "green-building-with-door" << "green-building" << "wood-building" <<
        "big-bed" << "small-bookshelf" << "bookshelf" << "small-television" <<
        "television" << "bench-stone" << "bench-wood" << "picnic-table-stone" <<
        "picnic-table-wood" << "minecart" << "fancy-house" << "small-wood-post"
        << "roof-texture" << "brick-chimney" << "tent";
