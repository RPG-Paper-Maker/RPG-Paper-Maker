...
public:
    ...
    SystemInitialPartyMember(int id = 1, QString name = "", PrimitiveValue *level =
        ...
        PrimitiveValueKind::DataBase, DEFAULT_HERO_ID), PrimitiveValue
        *variableInstanceID = new PrimitiveValue(PrimitiveValueKind::Variable,
        DEFAULT_VARIABLE_INSTANCE_ID));
