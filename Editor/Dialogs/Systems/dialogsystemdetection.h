...
private slots:
    ...
    void on_spinBoxLengthSquares_valueChanged(int i);
    void on_spinBoxLengthPixels_valueChanged(int i);
    void on_spinBoxWidthSquares_valueChanged(int i);
    void on_spinBoxWidthPixels_valueChanged(int i);
