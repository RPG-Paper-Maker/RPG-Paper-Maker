	...
	try {
		...
		if (baseDir) {
			...
			candidateDirs.push(
				...
				path.join(baseDir, 'Content', 'Data', 'Scripts', 'Plugins', 'DiscordRichPresence'),
				path.join(baseDir, 'app', 'Content', 'Data', 'Scripts', 'Plugins', 'DiscordRichPresence'),
				path.join(baseDir, 'resources', 'app', 'Content', 'Data', 'Scripts', 'Plugins', 'DiscordRichPresence'),
			);
		}
			...
			if (typeof document !== 'undefined' && document.location && document.location.href) {
				...
				if (loc.startsWith('file:')) {
					...
					candidateDirs.push(
						...
						path.join(locDir, 'Content', 'Data', 'Scripts', 'Plugins', 'DiscordRichPresence'),
						path.join(locDir, 'app', 'Content', 'Data', 'Scripts', 'Plugins', 'DiscordRichPresence'),
						path.join(
							locDir,
							'resources',
							'app',
...
function buildActivity() {
	...
	const details =
		customStatusMessage && customStatusMessage.trim().length > 0
