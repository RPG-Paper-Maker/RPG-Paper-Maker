...
import { COMMON_SKILL_ITEM_KIND, DYNAMIC_VALUE_OPTIONS_TYPE, INPUT_TYPE_WIDTH, SONG_KIND } from '../../../common';
...
function PanelCommonSkillItemContent({ selectedElement, kind, disabled = false }: Props) {
	...
	return (
		<Flex one spacedLarge fillWidth fillHeight>
			<Flex column spacedLarge>
				...
				<InputLocalization localization={description} disabled={disabled} widthType={INPUT_TYPE_WIDTH.FILL} />
				<Form>
					...
					<Value>
						<PlaySongSelector songKind={SONG_KIND.MUSIC} ref={playSoundSelectorRef} disabled={disabled} />
					</Value>
