...
function DialogCommandModifyInventory({ isOpen, setIsOpen, list, onAccept, onReject }: Props) {
	...
	const handleAccept = async () => {
		...
		onAccept(Model.MapObjectCommand.createCommand(EVENT_COMMAND_KIND.MODIFY_INVENTORY, newList));
	};
