...
function DialogCommandRemoveAPicture({ isOpen, setIsOpen, list, onAccept, onReject }: Props) {
	...
	const handleAccept = async () => {
		...
		onAccept(Model.MapObjectCommand.createCommand(EVENT_COMMAND_KIND.REMOVE_A_PICTURE, newList));
	};
