...
function DialogCommandCreateObjectInMap({ isOpen, setIsOpen, list, onAccept, onReject }: Props) {
	...
	const handleAccept = async () => {
		...
		onAccept(Model.MapObjectCommand.createCommand(EVENT_COMMAND_KIND.CREATE_OBJECT_IN_MAP, newList));
	};
