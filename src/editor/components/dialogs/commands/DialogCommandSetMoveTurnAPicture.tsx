...
function DialogCommandSetMoveTurnAPicture({ isOpen, setIsOpen, list, onAccept, onReject }: Props) {
	...
	const handleAccept = async () => {
		...
		onAccept(Model.MapObjectCommand.createCommand(EVENT_COMMAND_KIND.SET_MOVE_TURN_A_PICTURE, newList));
	};
