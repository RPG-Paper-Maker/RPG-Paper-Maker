		...
		<React.Fragment>
			<Menu mode='horizontal'>
				<SubMenu title='File'>
					...
					<MenuItem onClick={save} disabled={!isProjectOpened()}>
						Save
					</MenuItem>
					<MenuItem onClick={closeProject} disabled={!isProjectOpened()}>
						Close
					</MenuItem>
				</SubMenu>
				<SubMenu title='Edition'>
					<MenuItem onClick={zoomIn} disabled={!isProjectOpened()}>
						Zoom in
					</MenuItem>
					<MenuItem onClick={zoomOut} disabled={!isProjectOpened()}>
						Zoom out
					</MenuItem>
				</SubMenu>
				...
				<SubMenu title='Test'>
					<MenuItem onClick={play} disabled={!isProjectOpened()}>
						Play
					</MenuItem>
				</SubMenu>
