...
class Base extends Serializable {
	...
	public static DYNAMIC_VALUE_KIND_OPTIONS = [
		...
		Base.create(DYNAMIC_VALUE_KIND.FONT_SIZE, 'fontsize'),
		Base.create(DYNAMIC_VALUE_KIND.FONT_NAME, 'fontname'),
		Base.create(DYNAMIC_VALUE_KIND.COLOR, 'color'),
		Base.create(DYNAMIC_VALUE_KIND.WINDOW_SKIN, 'windowskin'),
