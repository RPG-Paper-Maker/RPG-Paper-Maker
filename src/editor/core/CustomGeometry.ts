...
class CustomGeometry extends THREE.BufferGeometry {
    ...
    static uvsQuadToTex(texA: THREE.Vector2, texB: THREE.Vector2, texC: THREE
        .Vector2, texD: THREE.Vector2, x: number, y: number, w: number, h: number) {
        texA.set(x, y);
        texB.set(x + w, y);
        texC.set(x + w, y + h);
        texD.set(x, y + h);
    ...
    pushQuadVertices(vecA: THREE.Vector3, vecB: THREE.Vector3, vecC: THREE.Vector3, 
        vecD: THREE.Vector3) {
        this.b_vertices.push(vecA.x, vecA.y, vecA.z);
        this.b_vertices.push(vecB.x, vecB.y, vecB.z);
        this.b_vertices.push(vecC.x, vecC.y, vecC.z);
    ...
    pushQuadUVs(texA: THREE.Vector2, texB: THREE.Vector2, texC: THREE.Vector2, 
        texD: THREE.Vector2) {
        this.b_uvs.push(texA.x, texA.y);
        this.b_uvs.push(texB.x, texB.y);
        this.b_uvs.push(texC.x, texC.y);
